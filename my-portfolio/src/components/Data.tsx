export const articles = [
  ...
  { title: "The Future of Web Development in 2025", date: "Jan 15, 2025" },
  { title: "A Guide to CSS Grid and Flexbox", date: "Dec 30, 2024" },
...
export const projects = [
  {
    id: 1,
    title: "Gadoski Blog",
    description: "Gadoski Blog is a platform where users can sign up, create their own posts, and read articles from others. It's a simple and fun place to share ideas, learn new things, and connect with people through writing.",
    techUsed: ["Flask", "SQLite", "SQLAlchemy", "Jinja2", "Bootstrap"],
    image: "/gadoski_web_blog.jpg",
    link: "https://blog.gadoski.tech/",
  },
  {
    id: 2,
    title: "ShopMeMart",
