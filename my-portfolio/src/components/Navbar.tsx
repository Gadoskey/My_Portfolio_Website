...
const Navbar = () => {
  return (
    <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 w-[84%] sm:w-[30rem] h-[1.7rem] sm:h-[2.6rem] rounded-[16px] border border-slate-950 bg-slate-900 border-opacity-40 bt-white z-50">
